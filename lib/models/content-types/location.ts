...
* Codename: location    
*/
export type Company_location = CoreContentType<
Company_locationElementCodenames,
{
                /**
                * Street Address
                * 
...
*/
export type Company_locationElementCodenames = 'street_address' | 'city' | 'state_province' | 'zipcode' | 'telephone_number' | 'directions';;
...
* Codename: location
*/
export function isCompany_location(item: CoreContentType | undefined | null): item is Company_location {
