...
* Codename: concert    
*/
export type Company_concert = CoreContentType<
Company_concertElementCodenames,
{
                /**
                * Title
                * 
...
* Guidelines: Link the support act for the concert if applicable.
                */ 
                readonly supporting_artist: Elements.LinkedItemsElement<Company_band>;
                /**
                * Ticket Purchasing
                * 
                * Type: text
...
*/
export type Company_concertElementCodenames = 'title' | 'event_date' | 'hero_image' | 'lead_paragraph' | 'untitled_rich_text' | 'supporting_artist' | 'ticket_purchasing' | 'concert';;
...
* Codename: concert
*/
export function isCompany_concert(item: CoreContentType | undefined | null): item is Company_concert {
