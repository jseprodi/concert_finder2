...
* Codename: person    
*/
export type Company_person = CoreContentType<
Company_personElementCodenames,
{
                /**
                * First Name
                * 
...
*/
export type Company_personElementCodenames = 'first_name' | 'last_name' | 'vocation';;
...
* Codename: person
*/
export function isCompany_person(item: CoreContentType | undefined | null): item is Company_person {
